...
//    [self addSubview:qrMenu];
    ...
    if ([self.delegate respondsToSelector:@selector(scanTypeConfig:)] ) {
        
        [self.delegate scanTypeConfig:nil];
    }
...
//    CGContextSetRGBStrokeColor(ctx, 83 /255.0, 239/255.0, 111/255.0, 1);//绿色
    CGContextSetRGBStrokeColor(ctx, 245 /255.0, 63/255.0, 67/255.0, 1);//红色
