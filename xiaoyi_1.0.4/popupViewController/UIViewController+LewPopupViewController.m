...
- (void)showSettingListZero:(id<LewPopupAnimation>)animation {
    [self performSegueWithIdentifier:@"showAboutWatchInfo" sender:self];
    [self dismissPopupViewWithAnimation:animation];
}

- (void)showSettingListOne:(id<LewPopupAnimation>)animation {
    [self performSegueWithIdentifier:@"showWatchParameters" sender:self];
    [self dismissPopupViewWithAnimation:animation];
}
- (void)showSettingListTwo:(id<LewPopupAnimation>)animation {
    [self performSegueWithIdentifier:@"showContacts" sender:self];
    [self dismissPopupViewWithAnimation:animation];
}
- (void)showSettingListThree:(id<LewPopupAnimation>)animation {
    [self performSegueWithIdentifier:@"showUserInfo" sender:self];
    [self dismissPopupViewWithAnimation:animation];
}
- (void)showSettingListFour:(id<LewPopupAnimation>)animation {
    [self performSelector:@selector(changeUserHeadImage)];
    [self dismissPopupViewWithAnimation:animation];
}
- (void)showSettingListFive:(id<LewPopupAnimation>)animation {
    [self performSegueWithIdentifier:@"showUrgentContacts" sender:self];
    [self dismissPopupViewWithAnimation:animation];
}

- (void)showSettingListSix:(id<LewPopupAnimation>)animation {
    [self performSegueWithIdentifier:@"showAttentionList" sender:self];
    [self dismissPopupViewWithAnimation:animation];
}
